          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <Box>
              {(() => {
                ...
                const defaultStudents = allStudents.filter(student => student.isDefaultAssigned || false);
                const manuallyAssigned = allStudents.filter(student => !student.isDefaultAssigned);
                              ...
                              {studentsToShow.map((student) => (
                                <Card 
                                  ...
                                  sx={{ 
                                    ...
                                    border: '1px solid',
                                    borderColor: student.isDefaultAssigned ? '#e0e7ff' : '#d1fae5',
                                    borderRadius: '6px',
                                    width: '100%',
                                    maxWidth: '280px',
                                    minWidth: '220px',
                                ...
                                >
                                  ...
                                  {selectedMentorDetails.type === 'Faculty' && (
                                    <Chip
                                      label={student.isDefaultAssigned ? 'Default' : 'Assigned'}
                                      size="small"
                                      sx={{
                                        position: 'absolute',
                                        top: 6,
                                        ...
                                        fontSize: '0.6rem',
                                        height: '18px',
                                        backgroundColor: student.isDefaultAssigned ? '#e0e7ff' : '#d1fae5',
                                        color: student.isDefaultAssigned ? '#3730a3' : '#065f46',
                                        fontWeight: 600,
                                        '& .MuiChip-label': {
                                          px: 0.5
                                        }
                                  ...
                                  {student.assignedDate && (
                                    <Typography variant="caption" sx={{ 
                                      ...
                                      {student.isDefaultAssigned ? 'Default Assignment' : `Assigned: ${new Date(student.assignedDate).toLocaleDateString()}`}
                                    </Typography>
                                  )}
                                </Card>
                              ))}
