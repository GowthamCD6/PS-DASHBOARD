...
const Dash = () => {
  ...
  <tr>
    {/* Total Levels */}
    <th style={{...styles.th, fontSize: '14px', fontWeight: '600' }}>Total Levels</th>

    {/* Completed */}
    <th style={{ ...styles.th, ...styles.thWithFilter, fontSize: '14px', fontWeight: '600' }}>
    ...
    >
      ...
      <IconButton
        ...
        sx={{
          ...
          top: '50%',
          right: '32px', // Align with cell padding
    ...
    >
      ...
      <IconButton
        ...
        sx={{
          position: 'absolute', // Position icon in the corner
          top: '50%',
          right: '10px', // Align with cell padding
          transform: 'translateY(-50%)',
          padding: '4px',
          backgroundColor: 'transparent',
          borderRadius: '4px',
    ...
    >
      ...
      >
        <span style={{ whiteSpace: 'nowrap' }}>Cumulative Rewards</span>
      </Box>
    ...
    >
      ...
      >
        <span style={{ whiteSpace: 'nowrap' }}>Current Sem Rewards</span>
      </Box>
