...
const Dash = () => {
  ...
  const styles = {
    ...
    // MODIFIED: Styles for the new button-like badge
    completedBadge: {
        ...
        <div style={styles.tableWrapper}>
          <table style={styles.table}>
            <thead style={styles.thead}>
              <tr>
                {/* MODIFICATION: Added width and adjusted padding for a narrower column */}
                <TableCell
                  sx={{
                    fontWeight: "600",
                    backgroundColor: "#f8fafc",
                ...
                >
                  ...
                  >
                    <span style={{ whiteSpace: "nowrap" }}>Completed</span>
                  </Box>
                ...
                >
                  ...
                  <IconButton
                    ...
                    sx={{
                      position: "absolute",
                      top: "50%",
                      right: "-5px", // Increased this value for better spacing, removed marginLeft
                      transform: "translateY(-50%)",
                      padding: "4px",
                      backgroundColor: "transparent",
                      borderRadius: "4px",
            ...
            <tbody style={styles.tbody}>
              {sortedStudents.map((student) => (
                <tr
                  key={student.id}
                  style={styles.tr}
                  // MODIFICATION: Added hover events to the row
                  onMouseOver={(e) => {
                ...
                >
                  {/* MODIFICATION: Adjusted padding to match header */}
                  <td style={{ ...styles.td, padding: '16px 24px' }}>{student.totalLevels}</td>
                  <td style={styles.td}>
                    {/* MODIFICATION: Changed to a styled span showing only completed levels */}
