            ...
            <tbody style={styles.tbody}>
              {students.length === 0 ? (
                ...
                students.map((student, idx) => (
                  <tr key={student.user_id || idx} style={styles.tr}>
                    ...
                    <TableCell>{student.course_total_levels}</TableCell>
                    <TableCell>{student.course_completed_levels}</TableCell>
                    <TableCell>{student.last_attempt_date ? new Date(student.last_attempt_date).toLocaleDateString() : '-'}</TableCell>
                    <TableCell>{student.gap_days}</TableCell>
                    <TableCell>{student.total_levels}</TableCell>
                    <TableCell>{student.total_completed_levels}</TableCell>
                  </tr>
                ))
              )}
            </tbody>
